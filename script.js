...
navLinks.forEach((menuItem, index) => {
  menuItem.addEventListener('click', function() {
    if (index == 0) {
      ...
      document.querySelector(`.section-2-wrapper`).style.transform = "scale(1)";

      document.querySelector(`.section-2`).style.left = "0";
      document.querySelector(`.section-2-wrapper`).style.transform = "scale(1.5)";

      document.querySelector(`.section-3`).style.left = "0";
      document.querySelector(`.section-3-wrapper`).style.transform = "scale(1.5)";

      document.querySelector(`.section-4`).style.left = "0";
      document.querySelector(`.section-4-wrapper`).style.transform = "scale(1.5)";

      document.querySelector(`.section-5`).style.left = "0";
      ...
      document.querySelector(`.section-1`).style.left = "-100vw";
      ...
      document.querySelector(`.section-2`).style.left = "-100vw";
      document.querySelector(`.section-2-wrapper`).style.transform = "scale(1.5)";

      document.querySelector(`.section-3`).style.left = "0";
      document.querySelector(`.section-3-wrapper`).style.transform = "scale(1)";
      ...
      document.querySelector(`.section-3`).style.left = "-100vw";
      document.querySelector(`.section-3-wrapper`).style.transform = "scale(1.5)";

      document.querySelector(`.section-4`).style.left = "0";
      document.querySelector(`.section-4-wrapper`).style.transform = "scale(1)";
      ...
      document.querySelector(`.section-4`).style.left = "-100vw";
      document.querySelector(`.section-4-wrapper`).style.transform = "scale(1.5)";
